    ...
    return (
        <>
            <nav className='z-50 w-full top-0 min-w-full mx-auto fixed start-0 flex justify-center items-center'>
                <motion.div
                    animate={[isRounded ? "resize" : "visible", isMenuOpen ? "open" : "close"]}
                    initial={false}
                    variants={navVariants}
                    className={cn('w-full bg-white dark:bg-black dark:shadow-inner dark:shadow-white/40 border shadow-lg py-2', isRounded && "md:rounded-full rounded-3xl", isMenuOpen && "w-full")}
                >
